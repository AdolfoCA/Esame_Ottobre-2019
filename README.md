...
### Modellazione
Di particolare importanza è la moderazione del csv, fatta ad "albero". Il tronco è la macrocategoria **MainCat** che presenta un numero *n* di sottocategorie **SubCat**,i rami dell'albero. Ciascuna SubCat è caratterizzata da una mappa di dati, le foglie, a ciuascuno dei quali è riferito un paese.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDk0MjY4NjMzXX0=
-->